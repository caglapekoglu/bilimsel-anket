  ...
  return (
    <div className='flex w-full h-screen flex-col '>
        <div className='grid grid-cols-3 h-7 pt-[50px] px-12' >
            <a href="/teklifal5"><ion-icon size='large' name="chevron-back"></ion-icon></a>
    ...
    <div className='flex w-full h-full flex-col justify-center items-center gap-y-4'>
        <h1 className='w-[400px] text-left text-xl'>6.Filtreleme sorusu ekleyiniz</h1>
        <p className='text-greyText w-[400px] text-left'>İsteğe bağlı*</p>
        ...
        <a href='/anketler' className='gap-x-3 rounded-xl my-4 bg-primary max-w-[400px] text-white border-[1px] items-end float-right flex  justify-center py-2 w-[200px]'>Başlat</a>
        </div>
    </div>
    </div>
  )
